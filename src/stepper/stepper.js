 ...
 * @link https://github.com/axdemelas/mdl-stepper
 */
...
(function () {
  ...
  /**
   * Issue: https://github.com/axdemelas/mdl-stepper/issues/14
  ...
  MaterialStepper.prototype.getSteps_ = function () {
    ...
    for (i = 0; i < stepElements.length; i++) {
      ...
      // More details here: <https://github.com/axdemelas/mdl-stepper/issues/11 />.
